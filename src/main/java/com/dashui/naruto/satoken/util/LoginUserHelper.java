...
public class LoginUserHelper {
    ...
    public static void loginByDevice(LoginAdmin loginAdmin, DeviceType deviceType) {
        ...
        StpUserUtil.login(loginAdmin.getId(), model.setExtra(USER_KEY, loginAdmin.getId()));
        StpUserUtil.getTokenSession().set(LOGIN_USER_KEY, loginAdmin);
    }
    ...
    public static LoginAdmin getLoginUser() {
        ...
        loginUser = (LoginAdmin) StpUserUtil.getTokenSession().get(LOGIN_USER_KEY);
    ...
    public static LoginAdmin getLoginUser(String token) {
        return (LoginAdmin) StpUserUtil.getTokenSessionByToken(token).get(LOGIN_USER_KEY);
    }
    ...
    public static Long getUserId() {
        ...
        try {
            ...
            if (ObjectUtil.isNull(userId)) {
                userId = Convert.toLong(StpUserUtil.getExtra(USER_KEY));
    ...
    //     return UserConstants.USER_ID.equals(userId);
    // }
